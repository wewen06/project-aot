...
<h2 style="text-align:center; padding-top: 1rem;">TAMBAH KARAKTER BARU</h2>
<div class="form-container" style="max-width:500px;">
<form action="/aot-website/actions/add_character.php" method="POST" enctype="multipart/form-data" onsubmit="return validateCharacterForm()">
